...
The outgoing on-call engineer of the payments team hands over to the incoming
one every Monday at 17:00 UTC, in a short call that follows this checklist.
The call should not last more than 30 minutes.
...
- The incoming engineer acknowledges the handover in the `#payments-handover`
