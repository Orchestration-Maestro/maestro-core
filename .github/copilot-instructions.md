...
│   │   │   └── SKILL.md                                                     # Perform a non-destructive cross-artifact consistency and quality analysis across spec.md, plan.md, and tasks.md after task generation
│   │   ├── speckit-checklist/                                               # Speckit checklist
│   │   │   └── SKILL.md                                                     # Generate a custom checklist for the current feature based on user requirements
│   │   ├── speckit-clarify/                                                 # Speckit clarify
│   │   │   └── SKILL.md                                                     # Identify underspecified areas in the current feature spec by asking up to 5 highly targeted clarification questions and encoding answers
│   │   ├── speckit-constitution/                                            # Speckit constitution
│   │   │   └── SKILL.md                                                     # Create or update the project constitution from interactive or provided principle inputs
│   │   ├── speckit-converge/                                                # Speckit converge
│   │   │   └── SKILL.md                                                     # Assess the current codebase against the feature's spec, plan, and tasks
│   │   ├── speckit-implement/                                               # Speckit implement
│   │   │   └── SKILL.md                                                     # Execute the implementation plan by processing and executing all tasks defined in tasks.md
│   │   ├── speckit-plan/                                                    # Speckit plan
│   │   │   └── SKILL.md                                                     # Execute the implementation planning workflow using the plan template to generate design artifacts
│   │   ├── speckit-specify/                                                 # Speckit specify
│   │   │   └── SKILL.md                                                     # Create or update the feature specification from a natural language feature description
│   │   ├── speckit-tasks/                                                   # Speckit tasks
│   │   │   └── SKILL.md                                                     # Generate an actionable, dependency-ordered tasks.md for the feature based on available design artifacts
│   │   └── speckit-taskstoissues/                                           # Speckit taskstoissues
│   │       └── SKILL.md                                                     # Convert existing tasks into actionable, dependency-ordered GitHub issues for the feature based on available design artifacts
...
│   │   ├── copilot.manifest.json                                            # JSON data: copilot.manifest
│   │   └── speckit.manifest.json                                            # JSON data: speckit.manifest
│   ├── memory/                                                              # Memory
│   │   ├── .constitution-template.json                                      # JSON data: constitution template
│   │   └── constitution.md                                                  # Maestro Constitution
│   ├── scripts/                                                             # Maintenance scripts
│   │   └── bash/                                                            # Bash
│   │       ├── check-prerequisites.sh                                       # Consolidated prerequisite checking script
│   │       ├── common.sh                                                    # Common functions and variables for all scripts
│   │       ├── create-new-feature.sh                                        # Check if the next argument is another option (starts with --)
│   │       ├── resolve-template.sh                                          # Shell script: resolve template
│   │       ├── setup-plan.sh                                                # Parse command line arguments
│   │       └── setup-tasks.sh                                               # Parse command line arguments
│   ├── templates/                                                           # Templates
│   │   ├── checklist-template.md                                            # [CHECKLIST TYPE] Checklist: [FEATURE NAME]
│   │   ├── constitution-template.md                                         # [PROJECT_NAME] Constitution
│   │   ├── plan-template.md                                                 # Implementation Plan: [FEATURE]
│   │   ├── spec-template.md                                                 # Feature Specification: [FEATURE NAME]
│   │   └── tasks-template.md                                                # Task list template for feature implementation
│   ├── workflows/                                                           # Workflows
│   │   ├── speckit/                                                         # Speckit
│   │   │   └── workflow.yml                                                 # 0.8.5 is the first release with engine-side resolution of the integration: "auto" default
│   │   └── workflow-registry.json                                           # JSON data: workflow registry
│   ├── .gitignore                                                           # Machine-local Spec Kit state — not meant to be shared
│   ├── init-options.json                                                    # JSON data: init options
│   └── integration.json                                                     # JSON data: integration
